...
// component
import SmFixedSideBar from "./SmFixedSideBar"
...
const FixedSideBar = () => {
    ...
    return (
        <>
            <aside
                className={`${styles.sidebar} ${state.language == "FA" && ""} 
            shadow-lg d-md-block d-none
            ...
            {/* sm sidebar */}
            <aside
                className={`${styles.sm_sidebar} ${state.language == "FA" && ""} 
                shadow-lg d-flx flex d-md-none
                ${state.darkMode && "text-light bg-dark"}`}
            >
                <ul>
                    {FixedSideBarData[state.language].map((item, index) => (
